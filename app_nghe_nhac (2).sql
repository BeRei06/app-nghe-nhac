...
--
-- Host: db
-- Generation Time: Jul 23, 2026 at 01:43 PM
...
INSERT INTO `songs` (`id`, `title`, `url`, `duration`, `category_id`, `album_id`, `artist_id`, `created_at`, `audio_url`) VALUES
(1, 'Chung Ta Cua Hien Tai', 'https://cloud-storage.com/music/ctcht.mp3', 302, 1, 1, 1, '2026-06-29 12:16:45', NULL),
(2, 'Mang Tien Ve Cho Me', 'https://cloud-storage.com/music/mtvcm.mp3', 280, 2, NULL, 2, '2026-06-29 12:16:45', NULL);
